...
- [ ] 2.3 `GET /api/analysis/fitness-trend` returns a non-empty [0,100] series with best/worst near 100/0
- [ ] 2.4 `?from&to` narrows the series and shifts scores (window-relative)
- [ ] 2.5 A user with no repeated segments gets `[]`
...
- [ ] 3.3 Completed state shows a line chart of score vs date
- [ ] 3.4 Y-axis fixed 0–100; hover shows date + score
- [ ] 3.5 Best workout near 100, worst near 0
- [ ] 3.6 No-scorable-data user sees the empty state, not a broken chart
- [ ] 3.7 No console errors; chart legible in the dashboard layout
